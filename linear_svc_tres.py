...
def linear_svc_tres(finC_x, finC_y, finT_x, finT_y):

    ttc1 = tt.t_test(finC_x, finC_y, 5000)

    ttt1 = tt.t_test(finT_x, finT_y, 5000)
    ...
    for num in features_num:
        ...
        ttc = tt.t_test(ttc1, finC_y, num)

        ttt = tt.t_test(ttt1, finT_y, num)

        tt_ = tt.t_test(new_x, finT_y, num)
