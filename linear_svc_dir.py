...
#This function performs RFE feature selection on direct data combination method along with training LinearSVC under 10-fold cross validation
...
def linear_svc_dir(finC_x, finC_y, finT_x, finT_y):
