...
#This function performs RFE feature selection along with training LinearSVC under 10-fold cross validation for resampling data combination
...
def lin_svc_res(finC_x, finC_y, finT_x, finT_y):
